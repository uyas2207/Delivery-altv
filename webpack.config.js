...
import webpack from 'webpack'; // ИМПОРТИРУЕМ WEBPACK
...
// Клиентская сборка (esm). Не бандлит alt-client и natives — оставляем как внешние esm-модули.
    ...
    // Серверная сборка (esm). Не бандлим alt-server/alt-shared — оставляем как внешние esm-модули.
    {
      ...
      entry: [     // Точка входа - главный файл серверной части, Webpack начнет сборку с этого файла и найдет все импорты 
      ...
      resolve: {
        ...
        // Добавляем алиасы для правильного разрешения путей
        alias: {
